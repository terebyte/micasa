  ...
  ko: {
    translation: {
      ...
      expense: {
        ...
        pausedBadge: '중지됨',
        records: '월별 기록',
        recordsHint: '관리비·전기세처럼 매달 다른 금액을 기록하고 부과서를 첨부하세요',
        addRecord: '기록 추가',
        editRecord: '기록 수정',
        period: '청구월',
        attachBill: '부과서 첨부',
      ...
      floorplan: {
        ...
        kindAsset: '물건',
        haEntity: 'HA 엔티티 ID',
        dragHint: '편집 모드에서 마커를 끌어서 옮길 수 있어요',
        planSettings: '도면 설정',
        rename: '이름 변경',
        replaceImage: '이미지 교체',
        deletePlan: '도면 삭제',
        deletePlanConfirm: '도면과 마커가 모두 삭제돼요. 계속할까요?',
      },
      enum: {
        interval: { monthly: '월', yearly: '년' },
        projectStatus: {
          ideating: '구상중',
          planned: '계획됨',
          quoted: '견적받음',
  ...
  en: {
    translation: {
      ...
      dashboard: {
        ...
        monthlyFixed: 'Monthly fixed costs',
        lowStock: 'Low supplies',
      ...
      asset: {
        ...
        name: 'Name',
        category: 'Category',
        categoryHint: 'e.g. furniture, electronics, tools, art',
      },
      consumable: {
        title: 'Supplies',
        addTitle: 'Add supply',
        ...
        unit: 'Unit',
        unitHint: 'e.g. pcs, packs',
        purchaseUrl: 'Purchase link',
        lowStock: 'Low!',
      },
      expense: {
        title: 'Fixed costs',
        addTitle: 'Add fixed cost',
        ...
        recordsHint: 'Track varying bills (HOA, electricity) and attach the scanned bill',
      ...
      floorplan: {
        ...
        dragHint: 'Drag markers to move them in edit mode',
        planSettings: 'Plan settings',
        rename: 'Rename',
        replaceImage: 'Replace image',
        deletePlan: 'Delete plan',
        deletePlanConfirm: 'This deletes the plan and all its markers. Continue?',
      },
      enum: {
